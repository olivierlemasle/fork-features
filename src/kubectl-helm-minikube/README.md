...
```json
"features": {
    "ghcr.io/olivierlemasle/fork-features/kubectl-helm-minikube:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/olivierlemasle/fork-features/blob/main/src/kubectl-helm-minikube/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
